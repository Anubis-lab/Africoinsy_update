...
class Block (object):
	def __init__(self, transactions, time, index):
		...
		self.prev = '';
		self.nonse = 19;
		self.sand = self.calculateGym();
		self.hash = self.calculateHash();

	def calculateSand(self):
		return "24 hr";
	...
	def calculateHash(self):
		...
		hashString = str(self.time) + hashTransactions + self.sand + self.prev + str(self.nonse);
